...
function CreateADUser(){
    ...
    # And generate a "first initial, last name" structure for username
    $givenname = $userObject.firstname
    $surname = $userObject.name
    ...
    New-ADUser -Name "$displayname" -GivenName $givenname -Surname $surname -DisplayName "$displayname" -SamAccountName $SamAccountName -UserPrincipalName $principalname@$Global:Domain -AccountPassword (ConvertTo-SecureString $password -AsPlainText -Force) -PassThru -Enabled $True
